...
/** Manually upload the CA database to the private store (Database page).
 * Mutating operations don't need this — the backend `store_ca_database` already
 * syncs the private store as part of every persist. */
