...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::aws::list_aws_credentials,
            commands::aws::get_aws_credential,
            commands::aws::set_aws_credential,
            ...
            commands::csr::generate_csr_from_cert,
            ...
            commands::cert::ignore_cert,
            commands::cert::unignore_cert,
            commands::cert::bulk_rekey_certs,
            commands::cert::bulk_renew_certs,
            commands::cert::bulk_revoke_certs,
            commands::cert::bulk_delete_certs,
            commands::cert::bulk_ignore_certs,
            commands::cert::bulk_unignore_certs,
            commands::cert::import_cert,
            commands::cert::inspect_certificate,
            commands::files::read_text_file,
            commands::dkim::list_dkim_keys,
            commands::dkim::sync_dkim_keys,
            commands::dkim::get_dkim_info,
            commands::dkim::backfill_dkim,
            commands::dkim::create_dkim_key,
            commands::dkim::delete_dkim_key,
            commands::dkim::verify_dkim_dns,
            commands::dkim::deploy_dkim_route53,
            commands::dkim::get_dkim_private_key,
            commands::dkim::record_dkim_copy,
            commands::crl::get_crl_info,
            commands::crl::backfill_crl,
            commands::crl::inspect_crl,
            commands::crl::generate_crl,
            commands::crl::upload_crl,
            commands::crl::record_crl_copy,
            ...
            commands::openvpn::sync_openvpn_templates,
            commands::openvpn::get_openvpn_template,
            commands::openvpn::save_openvpn_template,
            commands::openvpn::list_vpn_certs,
            commands::openvpn::get_vpn_profile_for_cn,
            commands::openvpn::generate_openvpn_profile,
            commands::openvpn::bulk_generate_openvpn_profiles,
            commands::openvpn::add_openvpn_profile_entries,
            commands::openvpn::list_openvpn_profiles,
            commands::openvpn::delete_openvpn_profile,
            commands::openvpn::bulk_delete_openvpn_profiles,
